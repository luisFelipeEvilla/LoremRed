...
public class LoremRed {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Remover el usuario 1, antes y despues
            System.out.println(app.getUser(1).getName());
            System.out.println(app.usuarios.get(0).getName());
            for (int i = 0; i < app.usuarios.count(); i++) {
                Usuario us = app.usuarios.get(i);
                if (us.getId() == 1) {
